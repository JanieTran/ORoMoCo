...
class _UserConfigurationScreenState extends State<UserConfigurationScreen> {
  ...
  GlobalKey<NumericComboLinePointChartState> _key = GlobalKey();
  ...
  */
  ...
  void initState() {
    ...
    numericComboLinePointChart = new NumericComboLinePointChart(key: _key);
            ...
            fakeData = Timer.periodic(Duration(milliseconds: 1000), (Timer t) {
              try{
                ...
                */
                ...
                _key.currentState.setData(rfPercentage: rfSignalPercentage, bluetoothPercentage: bluetoothSignalPercentage);
  ...
  Widget build(BuildContext context) {
    return isConfigured && currentMessageInBuffer.initialized ? Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Thông số hệ thống",
                  style: Theme.of(context).textTheme.headline5.copyWith(color: Color(0xFF7D7D7D)),
                  textAlign: TextAlign.left,
                )
              ),
              SizedBox(height: 10),
              ...
              SizedBox(height: 12),
              Container(
                child: textBuilder("full", "Tên sản phẩm", widget.perHardware.name, backgroundColor: Color(0xFFF5F5F5), color: Colors.grey)
              ),
              SizedBox(height: 12),
              Container(
                child: Column(
                  children: [
                    SizedBox(height: 12),
                    textBuilder("full", "Mã sản phẩm", widget.perHardware.hadrwareID, backgroundColor: Color(0xFFF5F5F5), color: Colors.grey),
                    SizedBox(height: 2),
                    textBuilder("full", "Phiên bản", widget.perHardware.version, backgroundColor: Color(0xFFF5F5F5), color: Colors.grey),
                    SizedBox(height: 2),
                    textBuilder("full", "Địa chỉ RF", widget.perHardware.address, backgroundColor: Color(0xFFF5F5F5), color: Colors.grey),
                    SizedBox(height: 2),
                    textBuilder("full", "Hỗ trợ Bluetooth", widget.perHardware.bluetoothSupport ? "Có" : "Không", backgroundColor: Color(0xFFF5F5F5), color: Colors.grey),
                    widget.perHardware.bluetoothSupport ? SizedBox(height: 2):Container(),
                    widget.perHardware.bluetoothSupport ? doubleTextBuilder("full", "Mã Bluetooth", widget.perHardware.bluetoothID, "Trạng thái", widget.perHardware.isConnectedTo() ? "Kết nối" : "Ngắt kết nối", "Thông tin Bluetooth", backgroundColor: Color(0xFFF5F5F5), color: Colors.grey):Container(),
                    SizedBox(height: 24),
                  ]
                ),
              ),
              ...
              Container(
                ...
                child: Stack(
                  children: <Widget>[
                    HorizontalBarLabelCustomChart.setData(rfPercentage: rfSignalPercentage, bluetoothPercentage: bluetoothSignalPercentage)
                  ],
                )
              ),
              SizedBox(height: 10),
